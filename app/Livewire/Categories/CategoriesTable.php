...
final class CategoriesTable extends PowerGridComponent
{
    ...
    public string $tableName = 'categories-table';
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable('categories_export_' . now()->format('Y_m_d'))
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ...
            ->add('name')
            ->add('slug')
            ->add('description', function ($category) {
        ...
        return [
            ...
            Button::add('delete')
                ...
                ->dispatch('open-delete-modal', [
                    'component' => 'categories.categories-table',
